<template>
  <div class="container">
    ...
    <div class="table">
        <div class="table-btn">
            <el-button size="mini" type="success" @click="addShow = true">添加错误码</el-button>
        </div>
      <el-table
        :data="tableData"
        size="small"
        ...
        <el-table-column align="center" prop="errorCode" label="错误码"></el-table-column>
      ...
      <div>
        <el-form ref="addForm" :model="addForm" size="small" label-width="105px">
          <el-form-item label="错误码">
            <el-input v-model="addForm.errorCode" placeholder="请输入错误码"></el-input>
          </el-form-item>
    ...
    <el-dialog
      ...
      <div>
        <el-form ref="updateForm" :model="updateForm" size="small" label-width="105px">
          <el-form-item label="错误码">
            <el-input v-model="updateForm.errorCode" placeholder="请输入错误码"></el-input>
          </el-form-item>
          <el-form-item label="备注">
